...
// Candidate discovery (Module 5.2), queried directly: there is no trigger yet (a later module
// decides when this runs and what it does with the result), so these tests call
// findCandidateJourneysNow the way that trigger eventually will.
