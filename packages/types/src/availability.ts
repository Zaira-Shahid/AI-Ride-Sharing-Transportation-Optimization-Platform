...
/**
 * Whether a driver may go online: an ACTIVE account, a VERIFIED driver, a VERIFIED vehicle and
 * its passenger seats set. Mirrored in functions/src/availability.ts, which is what enforces it;
