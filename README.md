...
Phase 2, Module 2.4 (driver verification). Phase 0 and Phase 1 (roles, registration, login, logout,
...
Staff can verify drivers and vehicles through server functions; the admin
dashboard for it, availability and journeys are not built yet, and the other
