...
Phase 2, Module 2.5 (availability). Phase 0 and Phase 1 (roles, registration, login, logout,
...
Staff can verify drivers and vehicles through server functions, and a verified driver can go
online or offline from the Home tab. The admin dashboard, destinations and journeys are not built yet, and the other
