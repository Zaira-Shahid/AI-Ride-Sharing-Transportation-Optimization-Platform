...
Phase 2, Module 2.8 (maximum detour). Phase 0 and Phase 1 (roles, registration, login, logout,
...
and go online or offline from the Home tab. The admin dashboard is not built yet, and the other
