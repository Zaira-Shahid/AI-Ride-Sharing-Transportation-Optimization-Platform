...
Phase 2, Module 2.3 (vehicle capacity). Phase 0 and Phase 1 (roles, registration, login, logout,
...
rating (read-only for now), and add their vehicle (type, make, model and a unique plate number) with 1 to 6 passenger seats.
Availability and journeys are not built yet, and the other
