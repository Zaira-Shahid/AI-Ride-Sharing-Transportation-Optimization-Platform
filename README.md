...
Phase 3, Module 3.1 (location search). Phase 2 (driver and vehicle) is complete. Phase 0 and Phase 1 (roles, registration, login, logout,
...
and go online or offline from the Home tab. Passengers can search for a place on their Home (also
needs the Maps key); the rest of the trip request is not built yet. The admin dashboard is not built
